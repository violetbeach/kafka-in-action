package com.violetbeach.kafkainaction.listener;

import com.violetbeach.kafkainaction.utils.JsonUtils;
...
public class StreamListener {
    ...
    public KStream<String, String> kStream(StreamsBuilder builder) {
        ...
        inputStream
                ...
                // outputTopic에 보낼 Json String으로 Generate
                .mapValues(JsonUtils::getSendingJson)
                // outputTopic 으로 보낼 key 값을 null로 설정
                .selectKey((key, value) -> null)
                // outputTopic 으로 메시지(null, jsonString) 전송 설정
